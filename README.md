...
UMass Rideshare is rideshare web application created for UMass students. 
It allows students to easily search for a ride to/from various airports and UMASS. It is unique as it is specifically designed to make the rideshare process easier than what it is now, and it is specifically tailored to UMASS students' needs. As of right now, whenever students need a ride, they have to make posts on social media to try and find someone to share a ride with. This is complicated and inefficient. Our app makes this faster with our search and request feature!
